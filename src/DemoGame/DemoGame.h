...
class PaddleSetupSystem : public SetupSystem
{
  void run()
  {
...
class SquareSetupSystem : public SetupSystem
{
  void run()
  {
...
class BallSetupSystem : public SetupSystem
{
  void run()
  {
...
class WallSystem : public UpdateSystem
{
  void run(float dT)
  {
...
public:
  ...
  void setup()
  {
    ...
    addSetupSystem<PaddleSetupSystem>(sampleScene);
    addSetupSystem<BallSetupSystem>(sampleScene);
    addSetupSystem<SquareSetupSystem>(sampleScene);
    addUpdateSystem<MovementSystem>(sampleScene);
    addUpdateSystem<WallSystem>(sampleScene);
